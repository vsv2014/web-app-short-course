...
update_app_config () {
  ...
  GOOGLE_CONFIG_FILE="/var/www/runtime/config/google_oauth_config.py"
  DB_USER="root"
  ...
  sed -i "s/<consumer-key>/60936275987-cg6a77vpb49g8mp93q7lc0k48jr7lvoc.apps.googleusercontent.com/" $GOOGLE_CONFIG_FILE
  sed -i "s/<secret-key>/dAmG4Nd3j8-3HYCCYyP2R8di/" $GOOGLE_CONFIG_FILE
...
#+BEGIN_SRC python :tangle webapp.wsgi :eval no
